...
openssl req -x509 -new -nodes -key /home/openvpn/config/ca/ca.key -sha256 -days 3650 -out /home/openvpn/config/ca/ca.crt -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=OpenVPN"
...
openssl req -new -key /home/openvpn/config/server.key -out /home/openvpn/config/server.csr -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=cicd.openvpn.com"
...
openssl req -new -key /home/openvpn/config/bookworm.key -out /home/openvpn/config/bookworm.csr -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=bookworm.openvpn.com"
openssl req -new -key /home/openvpn/config/bullseye.key -out /home/openvpn/config/bullseye.csr -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=bullseye.openvpn.com"
openssl req -new -key /home/openvpn/config/focal.key -out /home/openvpn/config/focal.csr -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=focal.openvpn.com"
openssl req -new -key /home/openvpn/config/jammy.key -out /home/openvpn/config/jammy.csr -subj "/C=SK/L=Kosice/O=Test/OU=Test/CN=jammy.openvpn.com"
